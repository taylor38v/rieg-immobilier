    ...
    <>
      <section className="relative text-ivory overflow-hidden bg-navy">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-28 grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
          <div className="fade-up">
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-medium mt-6 leading-[1.05]">{h.hero.titre}</h1>
            <p className="text-ivory/80 text-lg md:text-xl mt-8 max-w-2xl leading-relaxed">{h.hero.intro}</p>
            <div className="flex flex-wrap gap-4 mt-10">
              <Link href={h.hero.cta_primary_href} className="px-7 py-4 bg-gold text-navy font-medium hover:bg-gold-soft transition">{h.hero.cta_primary_label}</Link>
              <Link href={h.hero.cta_secondary_href} className="px-7 py-4 border border-ivory/30 hover:bg-ivory/10 transition">{h.hero.cta_secondary_label}</Link>
            </div>
      ...
      <section className="bg-navy-soft text-ivory py-12 border-y border-gold/30">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-[1fr_auto] gap-6 items-center">
          <div>
            <div className="text-xs uppercase tracking-[0.3em] text-gold">{h.biens_iad.surtitre}</div>
          ...
          <a href={h.biens_iad.cta_url} target="_blank" rel="noopener" className="px-6 py-4 bg-gold text-navy hover:bg-gold-soft text-center whitespace-nowrap">{h.biens_iad.cta_label}</a>
        </div>
      </section>

      <section className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <div className="text-xs uppercase tracking-[0.3em] text-gold">{h.qui_suis_je.surtitre}</div>
          <h2 className="font-serif text-5xl md:text-6xl mt-3 leading-tight">{h.qui_suis_je.titre}</h2>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            <Link href={h.qui_suis_je.cta_primary_href} className="px-6 py-3 bg-navy text-ivory hover:bg-gold hover:text-navy text-sm transition">{h.qui_suis_je.cta_primary_label}</Link>
            <a href={h.qui_suis_je.cta_secondary_href} target="_blank" rel="noopener" className="px-6 py-3 border border-navy text-navy hover:bg-navy hover:text-ivory text-sm transition">{h.qui_suis_je.cta_secondary_label}</a>
          </div>
        </div>
      ...
      <section className="bg-navy text-ivory py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gold">{h.services.surtitre}</div>
              <h2 className="font-serif text-5xl md:text-6xl mt-3">{h.services.titre}</h2>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <div>
            <div className="text-xs uppercase tracking-[0.3em] text-gold">{h.secteurs.surtitre}</div>
            <h2 className="font-serif text-5xl md:text-6xl mt-3">{h.secteurs.titre}</h2>
      ...
      <section className="bg-ivory-deep py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-xs uppercase tracking-[0.3em] text-gold">{h.instagram.surtitre}</div>
          <h2 className="font-serif text-5xl md:text-6xl mt-3">{h.instagram.titre}</h2>
          <p className="text-muted mt-3 max-w-2xl">{h.instagram.intro}</p>
          <div className="grid md:grid-cols-3 gap-4 mt-10">
            {h.instagram.videos.map((v) => (
              <a key={v.titre} href={v.url || h.instagram.lien} target="_blank" rel="noopener" className="group relative aspect-[9/16] overflow-hidden bg-navy">
          ...
          <div className="text-center mt-10">
            <a href={h.instagram.lien} target="_blank" rel="noopener" className="inline-block px-6 py-3 bg-navy text-ivory hover:bg-gold hover:text-navy text-sm transition">{h.instagram.cta_label}</a>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-14">
          ...
          <div className="text-xs uppercase tracking-[0.3em] text-gold mt-4">{h.avis.surtitre}</div>
          <h2 className="font-serif text-5xl md:text-6xl mt-3">{h.avis.titre}</h2>
        </div>
      ...
      <section className="bg-navy text-ivory">
        <div className="max-w-5xl mx-auto px-6 py-20 text-center">
          <h2 className="font-serif text-5xl md:text-6xl">{h.cta_final.titre}</h2>
          <p className="text-ivory/70 mt-6 max-w-2xl mx-auto">{h.cta_final.intro}</p>
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            <Link href={h.cta_final.cta_primary_href} className="px-7 py-4 bg-gold text-navy hover:bg-gold-soft">{h.cta_final.cta_primary_label}</Link>
            <a href={h.cta_final.cta_secondary_href} className="px-7 py-4 border border-ivory/30 hover:bg-ivory/10">{h.cta_final.cta_secondary_label}</a>
          </div>
        </div>
      </section>
    </>
