          ...
          <aside className="space-y-6">
            <div className="rounded-xl bg-white border border-ink/10 p-6">
              ...
              <div className="mt-6 space-y-5">
                ...
                <a href={`mailto:${c.sidebar.email}`} className="flex items-center gap-4 p-3 hover:bg-ivory-deep transition group">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-serif text-base text-navy group-hover:text-gold transition break-all">{c.sidebar.email}</div>
                  </div>
                </a>
              </div>
